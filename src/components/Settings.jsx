      ...
      <div className={styles.settingsRow}>
        <div className={styles.settingsGroup}>
          <div className={styles.buttonGroup}>
            ...
            <button 
              className={`${styles.optionButton} ${mode === 'time' ? styles.active : ''}`}
        ...
        {mode === 'time' && (
          <div className={styles.settingsGroup}>
            <div className={styles.buttonGroup}>
              <button 
                className={`${styles.optionButton} ${timeLimit === 15 ? styles.active : ''}`}
                onClick={() => setTimeLimit(15)}
              >
                15s
              </button>
              <button 
                className={`${styles.optionButton} ${timeLimit === 30 ? styles.active : ''}`}
                onClick={() => setTimeLimit(30)}
              >
                30s
              </button>
              <button 
                className={`${styles.optionButton} ${timeLimit === 60 ? styles.active : ''}`}
